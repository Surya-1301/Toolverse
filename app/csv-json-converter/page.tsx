...
export default function CsvJsonConverterPage() {
  ...
  return (
    <Container className="py-12 sm:py-16">
      ...
      <div className="mt-10 grid gap-6 lg:grid-cols-2">
        ...
        <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-4 sm:p-6 light:border-slate-900/10 light:bg-white">
          ...
          <textarea
            ...
            className="min-h-[440px] w-full rounded-2xl border border-white/10 bg-slate-950 p-4 font-mono text-sm leading-6 text-slate-100 outline-none light:border-slate-900/10 light:bg-white light:text-slate-900"
          />
        </div>
      </div>
      ...
      <HowToUse
        title="How to use CSV ↔ JSON Converter"
        subtitle=""
        steps={howToUseSteps}
      />
